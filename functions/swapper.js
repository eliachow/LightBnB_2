...
/lighthouse/functions/swapper.js
https://flex-web.compass.lighthouselabs.ca/workbooks/flex-m01w3/activities/233?journey_step=31&workbook=6

Sean Gray: seangray-dev
...
const swapper = function (key1, object1, key2, object2) {
  ...
  let temp = object1[key1]; // 1

  object1[key1] = object2[key2];
  object2[key2] = temp; //{ a: 1, b: 2, c: 3 }[a] = { a: 4, b: 3, c: 5 }[c]
...
// swapper("hello", { hi: 1, hello: 2, hey: 3 }, "goodbye", {
//   goodbye: 1,
//   bye: 2,
//   seeYa: 3,
// });
